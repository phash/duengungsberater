...
const mockProducts: FertilizerProduct[] = [
  { id: 'fp-kas', name: 'KAS 27% N', n_pct: 27, p2o5_pct: 0, k2o_pct: 0, mgo_pct: 4, s_pct: 0, form: 'mineral', affiliate_url: 'https://example.com', shop_name: 'Shop', active: true },
  { id: 'fp-dap', name: 'DAP 18/46', n_pct: 18, p2o5_pct: 46, k2o_pct: 0, mgo_pct: 0, s_pct: 0, form: 'mineral', affiliate_url: '', shop_name: 'Shop', active: false },
]
